...
My research aims to redefine our understanding of macrophages in inflammation. My research is holistic and operates at the level of the gene, the cell, tissue and the organism. I have a particular interest in type 2 immune responses, lung immunology, autoimmunity and incorporates cellular, clinical and bioinformatic techniques.

The concepts I uncovered in my recent publication in *Immunity* forms the basis of my current grant applications and aims to identify the factors that control macrophage differentiation during inflammation and how this impacts on disease outcomes.

I am ready to educate the next generation of doctors and scientists and lead my own group to make transformative discoveries in Immunology. I have a passion for enhancing research capacity through implementation of formalised structures to address the challenge of both generating and making sense of 'omics' data
...
-   Numerous active collaborations and bioinformatics support (see below)
...
-   Short-listed for academic-industry partnership with Janssen Pharmaceuticals, Belgium, 2019
...
* Li, X., and Jakubzick, C. V. (2023). Macrophages show up in style when Th2 lymphocytes organize their homecoming. Immunity 56, 900–902. 10.1016/j.immuni.2023.04.007.

* Paper featured on The Immunology Podcast - Episode 51 [https://www.immunologypodcast.com/ep-51-the-journey-of-cells-featuring-dr-doug-green]((link))
...
## Manuscripts in preparation, in review (without pre-prints)
