...
pacs <- c('vitae','tidyverse','readr','readxl','rorcid','rmarkdown','knitr','scholar','cowplot')
...
ggplot(ct, aes(year, cites)) +
  ...
  ylab('Citations') +
   annotate("text", x=2015, y=135, label= paste('Citations:',l$total_cites, ', h-index:', l$h_index)) +
