...
name: Conor M.
surname: Finlay
position: "Princible Investigator"
...
## Senior Research Fellow, Trinity College Dublin, 2023-present
...
data <- data.frame(
  Role = c("PI, Finlay Lab", "Scientific Director, TCD Omics", "Renal Research", "Pleural Disease Program", "Mast Cell Program"),
