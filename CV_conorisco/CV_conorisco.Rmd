...
<!-- -   Founder and scientific director of TCD Omics - Single cell RNA-sequencing core facility, 2021-present  -->
...
My group investigates innate immune cells in inflammation, combining molecular immunology, in vivo science and computational approaches to understand immune cell function in health and disease. Through leadership of TCD Omics and key clinical partnerships, we apply these approaches to understand human immune responses.
...
data <- data.frame(
  Role = c("PI, Finlay Lab", "Acedemic Director, TCD Omics", "Renal Research", "Pleural Disease Program", "Mast Cell Program"),
  #Period = c("2024-present", "2021-present", "2022-present", "2023-present", "2022-present"),
  Focus = c("Immune cell biology & bioinformatics", "Single cell RNA-seq facility", "Biomarker discovery", "Macrophage function", "Diagnostic development"),
  Partners = c("3 PhD students", "TTMI-supported RA", "Prof. Mark Little, ADAPT", "Assoc. Prof. Laura Gleeson", "Ridge, Conlon, Moran"),
  Outputs = c("Macrophage biology, computational immunology", "Core technology service", "Data analytics, translational research", "Translational immunology", "Clinical immunology")
)
